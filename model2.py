...
class LitResnet(pl.LightningModule):
    ...
    def validation_epoch_end(self, outputs):
        ...
        self.log('valid_loss_epoch', avg_val_loss, sync_dist=True)
        self.log('valid_acc_epoch', self.val_acc.compute(), sync_dist=True)
        self.val_acc.reset()
        # Method 2
    ...
    def test_epoch_end(self, outputs):
        ...
        self.log('test_loss_epoch', avg_test_loss, sync_dist=True)
    ...
    def training_epoch_end(self, outputs):
        ...
        self.log('train_loss_epoch', avg_train_loss, sync_dist=True)
